...
$(function(){
	...
	for(i =0; i<slideshows.length;i++){
		$("#slideshowComponents").append("<iframe id ='"+slideshow[i]"' class ='slideshowComp' src ='./slideshows/ "+ slideshow[i] + "/index.html'></iframe>");
	}
	//VIDEO COMPONENTS
	for(i =0;i<videos.length;i++){
		$("#videoComponents").append("<figure id = '"+video[i] +"'></figure>");
		$("#"+video[i]).append("<video></video>")
		$("#video").append("<source src='./videos/'"+video[i] + "'type=video/mp4'>")
	}
});