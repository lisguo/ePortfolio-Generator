...
public class StartupConstants {
    ...
    public static String PATH_SLIDESHOWS = "./slideshows/";
    public static String PATH_SKELETONS = "./src/epg/web/";
    ...
    public static String    CSS_CLASS_SLIDESHOW_READY = "slideshow_ready";
    ...
    public static String UI_PROPERTIES_FILE_NAME_Spanish = "properties_ES.xml";
    ...
    // HERE ARE THE LANGUAGE INDEPENDENT GUI ICONS
    public static String ICON_SSM_WINDOW_LOGO = "SSM_Logo.png";
    ...
    public static String    CSS_CLASS_LANG_DIALOG = "lang_dialog";
